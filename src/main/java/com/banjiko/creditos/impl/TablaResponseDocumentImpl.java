...
public class TablaResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.banjiko.creditos.TablaResponseDocument
{
    ...
    public static class TablaResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.banjiko.creditos.TablaResponseDocument.TablaResponse
    {
         ...
         */
        public com.banjiko.creditos.Table getTabla()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.banjiko.creditos.Table target = null;
                target = (com.banjiko.creditos.Table)get_store().find_element_user(TABLA$2, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setTabla(com.banjiko.creditos.Table tabla)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.banjiko.creditos.Table)get_store().add_element_user(TABLA$2);
                }
                target.set(tabla);
            }
        }
         ...
         */
        public com.banjiko.creditos.Table addNewTabla()
        {
            synchronized (monitor())
            {
                check_orphaned();
